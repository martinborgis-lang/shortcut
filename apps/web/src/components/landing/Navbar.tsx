        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-4 flex-shrink-0">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/sign-up"
                className="inline-block px-5 py-2 rounded-full bg-gradient-to-r from-purple-600 to-cyan-500 text-white text-sm font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-200"
              >
                Essai gratuit
              </Link>
            </motion.div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4 pt-4">
              ...
              <Link href="/sign-in" className="text-gray-300 hover:text-white transition-colors duration-200 text-left">
                Connexion
              </Link>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  href="/sign-up"
                  className="inline-block px-5 py-2 rounded-full bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-medium w-fit"
                >
                  Essai gratuit
                </Link>
              </motion.div>
